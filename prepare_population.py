...
def get_args():
    ...
    parser.add_argument(
        "-sacc", type=float, default=0.2, help="speak supervise training acc"
    )
    parser.add_argument(
        "-lacc", type=float, default=0.2, help="listen supervise training acc"
    )
    parser.add_argument(
        "-switch_dset",
        action="store_true",
        help="If true each model use different dataset",
    )
    parser.add_argument(
        "--max_steps",
        type=int,
